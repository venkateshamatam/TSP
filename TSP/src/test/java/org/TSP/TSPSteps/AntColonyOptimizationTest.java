...
import org.TSP.TSPsteps.AntColonyOptimization;
...
class AntColonyOptimizationTest {

    private AntColonyOptimization antColonyOptimizationUnderTest;
        ...
        public void testAntColony() {
            ...
            List<Vertex> antColony=new AntColonyOptimization(tour).solve();

            // Check that the new tour is shorter than the original tour
            int oldDistance = GraphUtils.calculateTotalDistance(tour, graph);
            int newDistance = GraphUtils.calculateTotalDistance(antColony, graph);
